/*******************************************************************************
  Filename:       mb.c
  Revised:        $Date: 2014-11-03 07:32:57 -0800 (Mon, 03 Nov 2014) $
  Revision:       $Revision: 40948 $
...
//       statically. While it's symbol was imported, it was marked as Local,
//       and thus can't be used by the flash build. To get around this, the
