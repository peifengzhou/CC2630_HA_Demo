/*******************************************************************************
  Filename:       rfHAL.h
  Revised:        $Date: 2015-01-20 13:55:24 -0800 (Tue, 20 Jan 2015) $
  Revision:       $Revision: 41922 $
...
#define CMD_SET_RAT_COMPARE            0x000A  // immediate ommmand
...
/*
** Radio Operation Receiver & Transmittter Command Packet Configuration
*/
...
// Radio Operation Radio Setup Hardware Register Overide
...
// CMD_TX: Radio Transmiter Command
PACKED_TYPEDEF_STRUCT
{
  rfOpCmd_t   rfOpCmd;                 // radio command common structure
...
// CMD_SYNC_START_RAT: Radio Synchroneously Start and Synchronize Stop RAT Command
PACKED_TYPEDEF_STRUCT
{
  rfOpCmd_t   rfOpCmd;                 // radio command common structure
  uint16      reserved;                // unused
...
{
  uint16            cmdNum;            // W:  radio command number
  uint16            address;           // W:  parameteter structure index
