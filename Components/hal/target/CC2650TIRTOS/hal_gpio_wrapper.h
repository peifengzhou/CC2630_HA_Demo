...
#define HAL_GPIO_INIT()                                                        \
  {                                                                            \
    ...
    IOCPinTypeGpioOutput( HAL_GPIO_5 );   /* SmartRF06EB         P403.6 */        \
    IOCPinTypeGpioOutput( HAL_GPIO_6 );   /* SmartRF06EB BTN_L   P403.8 */        \
    IOCPinTypeGpioOutput( HAL_GPIO_7 );   /* SmartRF06EB BTN_R   P405.10 */        \
    IOCPinTypeGpioOutput( HAL_GPIO_8 );   /* SmartRF06EB BTN_UP  P405.12 */        \
  }
...
#define HAL_GPIO_5                  IOID_1   // GPIO22 SmartRF06EB         P403.6
#define HAL_GPIO_6                  IOID_15  // GPIO22 SmartRF06EB BTN_L   P403.8 
#define HAL_GPIO_7                  IOID_18  // GPIO22 SmartRF06EB BTN_R   P405.10
#define HAL_GPIO_8                  IOID_19  // GPIO22 SmartRF06EB BTN_UP  P405.12
