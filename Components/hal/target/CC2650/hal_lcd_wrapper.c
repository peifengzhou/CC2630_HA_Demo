/**************************************************************************************************
  Filename:       hal_lcd_wrapper.c
  Revised:        $Date: 2013-09-06 11:41:44 -0700 (Fri, 06 Sep 2013) $
  Revision:       $Revision: 35242 $

  Description:    This file contains the implementation to the HAL LCD Service.
                  This file is a wrapper for the LCD driver api.
 ...
 * @fn          halLcdClear
 *
 * @brief       Clears the default buffer and the LCD.
 *
 * @param       none
 *
 * @return      none
...
#if (HAL_LCD == TRUE)
    //Clear the buffer
    lcdBufferClear( BSP_DEFAULT_BUFFER );
