/**************************************************************************************************
  Filename:       hal_led_wrapper.c
  Revised:        $Date: 2013-08-28 10:08:19 -0700 (Wed, 28 Aug 2013) $
  Revision:       $Revision: 35144 $

  Description:    This file contains the implementation to the HAL LED Service.
                  This file is a wrapper file for bsp_led.
...
void HalLedExitSleep( void )
{
  ...
  // Restart - This takes care of BLINKING LEDS.
  HalLedUpdate();
#endif /* HAL_LED */
