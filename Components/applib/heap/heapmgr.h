/**
  ...
  <!--
  Revised:        $Date: 2013-12-06 06:24:24 -0800 (Fri, 06 Dec 2013) $
  Revision:       $Revision: 36421 $
...
/* macros to override the function names for efficent linking and multiple instantiations */
#ifndef HEAPMGR_INIT
...
/* macros to lock and unlock a mutex to synchonize tasks using this heap */
#ifndef HEAPMGR_LOCK
#define HEAPMGR_LOCK()
#endif
...
hmU16_t HEAPMGR_MEMUB = 0;   // Upperbound of memory usage
