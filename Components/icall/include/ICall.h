 ...
 * before ICall is initializd, so that ICall can serve "get reset reason"
 * function.
 */
 ...
 * @param format  messag format. See ICall_sendServiceMsg().
 * @param msg     pointer to the message body.
 * @return @ref ICALL_ERRNO_SUCCESS when successful.<br>
 ...
 *
 * @param msecs  timeout period in miliseconds after which callback function
 *               shall be called.
...
/**
 * Retrieves power transiton state.
 *
