/**************************************************************************************************
  Filename:       mac_beacon.h
  Revised:        $Date: 2013-05-17 11:08:52 -0700 (Fri, 17 May 2013) $
  Revision:       $Revision: 34354 $

  Description:    Interface to procedures for beacon enabled networks common to both device
                  and coordinator.
...
MAC_INTERNAL_API uint8 macBeaconCheckTxTime(void);
