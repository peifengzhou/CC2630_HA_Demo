/**************************************************************************************************
  Filename:       mac_coord.h
  Revised:        $Date: 2013-05-17 11:05:33 -0700 (Fri, 17 May 2013) $
  Revision:       $Revision: 34353 $

  Description:    Internal interface file for the MAC coordinator module.
...
typedef struct
{
  ...
  macMlmeStartReq_t   *pStartReq;         /* buffer allocated to store copy of start parameters */
...
MAC_INTERNAL_API void macStartSetParams(macMlmeStartReq_t *pStartReq);
